...
def api():
    ...
    output_format = request.args.get('format', 'PNG').upper()
    ...
    def get_response_image(pil_img, format):
        """Convert PIL Image to base64 encoded string in the specified format."""
        byte_arr = io.BytesIO()
    ...
    try:
        ...
        encoded_img = get_response_image(pil_img, output_format)
